...
Short Description: Simple Pie Chart Block allows you to create elegant and minimal pie charts using the ChartJS library.
...
Upload and then Activate the plugin through the 'Plugins' screen in WordPress.
