...
const initChart = chart => {
  ...
  const data = (0,_lib_chartUtils__WEBPACK_IMPORTED_MODULE_1__.sliceData)(slices);
  const chartInstance = new chart_js__WEBPACK_IMPORTED_MODULE_2__.Chart(canvas, {
    type: chartType.toLowerCase(),
    data: data,
    options: _lib_chartUtils__WEBPACK_IMPORTED_MODULE_1__.chartOptions,
